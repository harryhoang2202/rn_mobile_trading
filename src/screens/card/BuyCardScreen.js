...
export default function BuyCardScreen({ navigation, route }) {
  ...
  const prepareTx = async () => {
    ...
    try {
      ...
      const cardPrice = parseFloat(item.price) / parseFloat(price[0]);
      setCardFee(`${cardPrice}`);
      ...
      Logs.error("BuyCardScreen: prepareTx" + error);
    } finally {
      CommonLoading.hide();
    }
  };
  const executeTX = async () => {
    ...
    try {
      ...
      Logs.error("BuyCardScreen: executeTX" + error);
      CommonAlert.show({
        title: t("alert.error"),
        message: error,
        type: "error",
          ...
          <View style={styles.item}>
            ...
            <View style={styles.itemContent}>
              <View style={{ paddingVertical: 5 }}>
                ...
                <CommonText
                  style={[
                    { color: theme.subText, fontWeight: "500", fontSize: 14 },
                  ]}
                  numberOfLines={1}
                >
                  {methodItem.symbol}
      ...
      <SafeAreaView style={styles.container}>
        <ScrollView>
          ...
          <View style={styles.buttonContainer}>
            ...
            {/* <CommonGradientButton text={"Pay"} onPress={prepareTx} /> */}
            <TouchableOpacity
              onPress={prepareTx}
              style={{
                justifyContent: "center",
